...
export default function Hero({ onSelectSection, t }) {
  ...
  const roles = t.hero.roles || ['> Web Developer', '> IT Support', '> Video Editor', '> Coffee Enthusiast'];
        ...
        <div className="hero__grid">
          ...
          <div className="hero__text-col">
            ...
            <h1 className="hero__title">
              {t.hero.titlePrefix}<span className="accent-text">{t.hero.name}</span>
            </h1>

            {/* Typewriter Role */}
            <div className="hero__typewriter-box">
            ...
            <div className="hero__actions">
              ...
              <a
                ...
                className="btn hero__github-btn"
